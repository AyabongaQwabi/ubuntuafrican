      ...
      <div className='container mx-auto px-4'>
        <div className='grid gap-8 md:grid-cols-2 lg:grid-cols-4'>
          ...
          <div>
            ...
            <a className='mb-2' href='mailto:ubuntuafricanresources@gmail.com'>
              Email:{' '}
              <span className='text-sky-500'>
                ubuntuafricanresources@gmail.com
              </span>
            </a>
            <br />
            <a href='tel:0614038651'>
              Phone: <span className='text-sky-500'>0614038651</span>
            </a>
          </div>
          <div>
        ...
        <div className='mt-8 flex flex-col items-center justify-between space-y-4 border-t border-gray-700 pt-8 sm:flex-row sm:space-y-0'>
          <p className='text-sm text-gray-400'>
            &copy; {new Date().getFullYear()} Ubuntu African Resources. All
            rights reserved.
          </p>
