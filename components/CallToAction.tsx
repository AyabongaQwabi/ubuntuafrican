...
import { Phone, Mail, Send, CheckCircle, AlertCircle, Loader2, MapPin, Clock, Twitter, Linkedin } from "lucide-react"
    ...
    <section id="contact" className="bg-primary py-24">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mb-8 text-lg text-white/80">Join us in shaping the future of sustainable mineral trade.</p>
        </motion.div>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <Card className="bg-white/95 backdrop-blur">
              ...
              <CardContent>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Input type="tel" name="phone" placeholder="Your Phone Number" required disabled={isSubmitting} />
                  <Select name="service" required disabled={isSubmitting}>
                    <SelectTrigger>
                      <SelectValue placeholder="Select a service" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="mining-operations">Mining Operations</SelectItem>
                      <SelectItem value="rehabilitation">Rehabilitation and Environmental Management</SelectItem>
                      <SelectItem value="supply-materials">Supply of Mining Materials</SelectItem>
            ...
            <Card className="bg-white/95 backdrop-blur">
              <CardHeader>
                ...
                <CardDescription>
                  Prefer to speak with us directly? Give us a call for immediate assistance.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="text-center">
                    ...
                    <h4 className="mb-2 text-lg font-semibold">Primary Contact</h4>
                    <p className="mb-2 text-xl font-bold text-green-600">+27 61 403 8651</p>
                    <Button
                  ...
                  <div className="text-center border-t pt-4">
                    <h4 className="mb-2 text-lg font-semibold">Alternative Contact</h4>
                    <p className="mb-2 text-xl font-bold text-green-600">060 309 5359</p>
                    <Button
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <Card className="bg-white/95 backdrop-blur">
              ...
              <CardContent className="space-y-4">
                <div>
                  <p className="text-sm text-gray-600 mb-3">puleng@ubutuafrican.co.za</p>
                </div>
